...
function root({
  ...
  return {
    title: shop?.name,
    titleTemplate: 'PetSnowy SNOW⁺ | Self-Cleaning, Odor Free, Auto-Packing - PETSNOWY US',
    description: 'Building a comfortable lifestyle for pets and pet owners Explore our innovations.',
    handle: '@shopify',
    url,
    robots: {
      noIndex: false,
